  ...
  return (
    <>
      <section className="bg-gray-100 min-h-screen flex box-border justify-center items-center">
        <div className="bg-[#F2F2F2] rounded-2xl flex max-w-3xl p-5 items-center">
          {/* <div className="bg-[#F2F2F2] rounded-2xl flex max-w-5xl p-5 items-center w-full"> */}
          <div className="md:w-1/2 px-8">
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className={`bg-[#002D74] text-white py-2 rounded-xl font-medium hover:scale-105 duration-300 ${
                  loading
          ...
          <div className="md:block hidden w-1/2 flex-1">
            <img
              className="rounded-2xl w-full h-full object-cover min-h-[500px]"
              src="/image.png"
